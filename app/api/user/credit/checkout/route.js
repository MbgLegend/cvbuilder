...
if (process.env.STRIPE_SECRET_KEY === undefined || process.env.STRIPE_CREDIT_PRICE_ID === undefined ) {
    throw new Errror("STRIPE_SECRET_KEY || STRIPE_CREDIT_PRICE_ID is not defined")
}
...
export async function POST(req) {
    try {
        ...
        console.error("Stripe credit purchase Checkout Error:", error)
